...
int _focusSessionEstimateSize(
  ...
  bytesCount += 3 + object.soundsUsed.length * 3;
  {
    for (var i = 0; i < object.soundsUsed.length; i++) {
      final value = object.soundsUsed[i];
...
void _focusSessionSerialize(
  ...
  writer.writeStringList(offsets[5], object.soundsUsed);
...
FocusSession _focusSessionDeserialize(
  ...
  object.soundsUsed = reader.readStringList(offsets[5]) ?? [];
...
extension FocusSessionQueryWhereSort
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhere> anyStartTime() {
    return QueryBuilder.apply(this, (query) {
...
extension FocusSessionQueryWhere
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhereClause> startTimeEqualTo(
      DateTime startTime) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhereClause> startTimeLessThan(
    DateTime startTime, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterWhereClause> startTimeBetween(
...
extension FocusSessionQueryFilter
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterFilterCondition>
      soundsUsedElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'soundsUsed',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterFilterCondition>
      soundsUsedElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'soundsUsed',
        value: value,
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterFilterCondition>
      soundsUsedElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'soundsUsed',
        wildcard: pattern,
  ...
  QueryBuilder<FocusSession, FocusSession, QAfterFilterCondition>
      soundsUsedLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
...
extension FocusSessionQueryWhereDistinct
  ...
  QueryBuilder<FocusSession, FocusSession, QDistinct> distinctBySoundsUsed() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'soundsUsed');
    });
  }
...
extension FocusSessionQueryProperty
  ...
  QueryBuilder<FocusSession, List<String>, QQueryOperations>
      soundsUsedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'soundsUsed');
    });
  }
